...
## Installation
1. Install via [HACS](https://hacs.xyz/) as a custom repository (`https://github.com/tjuuljensen/FlashForgeGuider2s`), or copy this repository to `custom_components/flashforge_guider_2s` in your Home Assistant config directory.
